...
## 场景对照索引（评委抽查入口 · 2026-08-03）

| 标签 | 赛题场景 | 精品段（锚点） | 一句话 |
|------|----------|----------------|--------|
| kernel | 算子 kernel 设计/调试/优化 | [记录 3](#agent-交互记录-3) · [记录 6](#agent-交互记录-6) · [记录 25](#agent-交互记录-25--官网级-spectralconv3d-四角扩展2026-08-02) | SUPA mul → fused → 3D 四角 |
| bottleneck | 性能瓶颈分析与定位 | [尝试 1](#尝试-1--性能瓶颈hostdevice) · [记录 6](#agent-交互记录-6) · [记录 30](#agent-交互记录-30--operator_opt_loop-规范流程优化2026-08-02) | H↔D → C2R 墙；P0–P6 loop |
| hyperparam | 模型架构选型与超参搜索 | [记录 26](#agent-交互记录-26--stop-on-gate-快路径与-r5-promote2026-08-02) · [记录 32](#agent-交互记录-32--freeze_r9-promote-与-round10-启动2026-08-03) · [公开 NS64](#2026-07-31--public-ns64-autochain) | freeze 抛光；gate 纪律 |
...
| viz | 结果分析与可视化 | [记录 5](#agent-交互记录-5) · [记录 27](#agent-交互记录-27--评测报告规范与答辩口径2026-08-02) · [记录 32](#agent-交互记录-32--freeze_r9-promote-与-round10-启动2026-08-03) | 报告 v8 + 材料对齐 |

| 主报口径 | 值 |
|----------|-----|
| 公开 NS64 L2 | **0.035302**（`freeze_r9` · 版本 v8） |
| Spectral idle | **3.811 / 8.054 / 29.560 ms**（冻结） |
| 行动方针 | [`OPT_ROUND10_PLAN_2026-08-03.md`](results/run_logs/OPT_ROUND10_PLAN_2026-08-03.md) |
| 官方对照 | [`SUBMISSION_CHECKLIST.md`](SUBMISSION_CHECKLIST.md) · [`OFFICIAL_ASSET_ALIGNMENT_2026-08-02.md`](results/run_logs/OFFICIAL_ASSET_ALIGNMENT_2026-08-02.md) |
...
| 评测报告 | `/workspace/评测报告_最新指标_2026-08-03_205100.md`（规范见根 `AGENTS.md`） |
