...
| 类 | 路径 | 留什么 |
|----|------|--------|
| 必选算子 | `spectral_conv/` | 裁剪 DFT 热路径 + suFFT 回退；`./scripts/reproduce.sh` |
...
| Spectral idle | **0.599 / 1.405 / 5.099 ms**（`pinned_src_r1` · v13 · 2026-08-16） |
| 评测报告 | `/workspace/评测报告_最新指标_2026-08-16_094942.md` |
