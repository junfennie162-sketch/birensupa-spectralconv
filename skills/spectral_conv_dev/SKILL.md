...
现行前向（warmup=10，iters=100，CPU 入 CPU 出）：**0.599 / 1.405 / 5.099 ms** @64/128/256；相对本机官网 CPU 参考大约 123.8× / 63.3× / 58.0×。上一主表 0.764 / 1.827 / 6.504 ms。正确性最差相对误差（默认裁剪路径）**7.162×10⁻⁶**。
