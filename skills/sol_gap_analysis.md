...
依据：选手手册中 SOL-Score / SOL-ExecBench **思路**（队内 proxy，非官方分）。见 `/workspace/赛题文档/算子与模型赛道选手手册.md`。  
现行 Spectral 主表：**3.811 / 8.054 / 29.560 ms**（idle，2026-07-31）；瓶颈叙事以 irfft/C2R 墙为准。
